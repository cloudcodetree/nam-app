...
// CHANNELS row + "+ capture" (amp), footer "SWAP GEAR" (+ "REMOVE" for
// pedal/post). Same full-parent-bounds / self-scrim / height-capped sheet
// convention as StackGearPicker.
//
// Stripped 2026-08-15 (Chris): the FOOTSWITCH row (NONE, FS1-8) is gone --
// footswitch assignment was PERFORM-only, and PERFORM itself no longer
...
private:
    ...
    juce::Rectangle<int> sheetRect_, contentRect_, typeLabelRect_, nameRect_, bypassPillRect_,
        channelsLabelRect_, addChannelRect_, swapBtnRect_, removeBtnRect_;
