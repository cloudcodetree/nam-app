...
public:
    ...
    void setDefaultModel (int packIdx, int modelIdx,
                          juce::String name);      // what "Auto" resolves to
...
private:
    ...
    juce::Rectangle<int> backRect_, badgeRect_, searchBox_, filtersBtn_, sortBtn_, favBtn_,
        countRect_, filterPanel_, statusRect_;
    struct Chip {
        juce::String label;
