...
static juce::Typeface::Ptr caslonTypeface() {
    static juce::Typeface::Ptr tf =
        juce::Typeface::createSystemTypefaceFor (BinaryData::LibreCaslon_ttf,
                                                 (size_t) BinaryData::LibreCaslon_ttfSize);
    return tf;
}
static juce::Typeface::Ptr workSansTypeface() {
    static juce::Typeface::Ptr tf =
        juce::Typeface::createSystemTypefaceFor (BinaryData::WorkSans_ttf,
                                                 (size_t) BinaryData::WorkSans_ttfSize);
    return tf;
}
...
void paintHeroBackground (juce::Graphics& g, juce::Rectangle<int> bounds, bool withGlow) {
    ...
    if (withGlow) {
        ...
        juce::ColourGradient glow (col::accentA (0.12f), gx, gy,
                                   col::accent.withAlpha (0.0f), gx + gr, gy, true);
...
void drawPill (juce::Graphics& g, juce::Rectangle<float> r,
               juce::Colour fill, juce::Colour stroke, float strokeWidth) {
